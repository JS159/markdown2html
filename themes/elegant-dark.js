    ...
    tables.forEach(function(table) {
        ...
        if (window.innerWidth < 768) {
            wrapper.style.background = 
                'linear-gradient(to right, #2d3748 30%, rgba(45, 55, 72, 0)), ' +
                'linear-gradient(to left, #2d3748 30%, rgba(45, 55, 72, 0)) 100% 0, ' +
